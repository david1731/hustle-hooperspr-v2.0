  ...
  return (
    <section className="text-gray-600 body-font">
      <div className="max-w-full pt-52 pb-24 mx-auto px-4"> {/* Adjusted max width and added padding */}
        <h1 className="text-4xl md:text-80 text-center font-4 lh-6 ld-04 font-bold text-white mb-6">
          ¡Bienvenidos a HustleHoopersPR!
        </h1>
        <h2 className="text-xl md:text-2xl font-4 font-semibold lh-6 ld-04 pb-11 text-gray-700 text-center">
      ...
      <div id="servicios" className="container flex flex-col items-center justify-center mx-auto">
        <img
          className="object-cover object-center w-full md:w-3/4 mb-10 border shadow-md g327"
      ...
      <div className="pt-12 pb-24 max-w-4xl mx-auto fsac4 md:px-1 px-3">
        <div className="ktq4">
          <img className="w-20 md:w-10" src="/John-Wall-Jump-Shot.jpg"></img>
        ...
        <div className="ktq4">
          <img className="w-20 md:w-10" src="/basketball-dribble.webp"></img>
          <h3 className="pt-3 font-semibold text-lg text-white">
            Manejo de Balón
          </h3>
          <p className="pt-2 value-text text-md text-gray-200 fkrr1">
        ...
        <div className="ktq4">
          <img className="w-20 md:w-10" src="/how-to-shoot-a-basketball.jpg"></img>
          <h3 className="pt-3 font-semibold text-lg text-white">
      ...
      <div id="mision">
        ...
        <div className="pt-32 pb-32 max-w-6xl mx-auto flex flex-col items-center">
